    ...
    >
      ...
      <el-table-column align="center" prop="message_title" label="标题" min-width="200">
        <template slot-scope="scope">
          <el-popover width="200" trigger="click" :content="scope.row.message_title" placement="top">
      ...
      <el-table-column align="center" prop="message_detail" label="详情" min-width="300">
        <template slot-scope="scope">
          <el-popover width="500" trigger="click" :content="scope.row.message_detail" placement="top">
...
export default {
  ...
  computed: {
    ...mapState("message", ["multipleSelection", "currentPage", "pageSize", "messageList"]),
  },
  methods: {
